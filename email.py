...
ki = LineClient("ksamr880@gmail.com","ssaa1122")
...
KAC = [ki,kk,kc,kb,kd,ke,kf]
ABC = [ki,kk,kc,kb,kd,ke,kf]
GHOST = [kj,sw]
Bots = [Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Jmid,Zmid]
Saints = admin + staff
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                ...
                                gMembMids = [contact.mid for contact in group.invitee]
                                for mid in gMembMids:
                                    ki.cancelGroupInvitation(op.param1,[mid])
                            except:
                                try:
                                    group = kc.getGroup(op.param1)
                                    gMembMids = [contact.mid for contact in group.invitee]
                                    for mid in gMembMids:
                                        kc.cancelGroupInvitation(op.param1,[mid])
                                except:
                                    try:
                                        ...
                                        try:
                                            ...
                                            try:
                                                ...
                                                gMembMids = [contact.mid for contact in group.invitee]
                                                for mid in gMembMids:
                                                    kd.cancelGroupInvitation(op.param1,[mid])
                                            except:
                                                pass
            ...
            if wait["autoAdd"] == True:
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    if (wait["message"] in [" "," ","\n",None]):
                        ...
                        kj.sendMessage(op.param1, wait["message"])
                ...
                try:
                    ...
                    try:
                        if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                            ...
                            sw.acceptGroupInvitationByTicket(op.param1,Ticket)
                            sw.kickoutFromGroup(op.param1,[op.param2])
                            sw.findAndAddContactsByMid(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid])
                            sw.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid])
                            wait["blacklist"][op.param2] = True
                            sw.sendMessage(op.param1,"")
                            sw.leaveGroup(op.param1)
                            random.choice(ABC)inviteIntoGroup(op.param1,[Zmid,Jmid])
                            wait["blacklist"][op.param2] = True
                            X.preventedJoinByTicket = True
                            ki.updateGroup(X)
                    except:
                        try:
                            if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                                ...
                                kk.findAndAddContactsByMid(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid])
            ...
            try:
                ...
                if op.param3 in Zmid:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        random.choice(ABC).findAndAddContactsByMid(op.param3)
                        random.choice(ABC).inviteIntoGroup(op.param1,[Zmid])
                        random.choice(ABC).sendMessage(op.param1,"")
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        ...
                                                        try:
                                                            ...
                                                            G = kc.getGroup(op.param1)
                                                            G.preventedJoinByTicket = False   
															kc.findAndAddContactsByMid(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid])															
                                                            kc.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid])     
                                                            cl.acceptGroupInvitation(op.param1)
                                                            cl.kickoutFromGroup(op.param1,[op.param2])
                                                            ki.acceptGroupInvitation(op.param1)
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        ...
                                                        try:
                                                            ...
                                                            G = kb.getGroup(op.param1)
                                                            G.preventedJoinByTicket = False   
															kb.findAndAddContactsByMid(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid])															
                                                            kb.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid])     
                                                            cl.acceptGroupInvitation(op.param1)
                                                            cl.kickoutFromGroup(op.param1,[op.param2])
                                                            ki.acceptGroupInvitation(op.param1)
                 ...
                 if text is None:
                     return
                        ...
                        if cmd == "self on":
                            ...
                            if msg._from in admin:
                                wait["selfbot"] = False
                                cl.sendText(msg.to, "Selfbot turn on")
...
#                                wait["myProfile"]["coverId"] = str(coverId)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              ...
                              if ginvited != [] and ginvited != None:
                                  ...
                                  cl.sendMessage(to, "".format(str(len(ginvited))))
                              else:
                                  cl.sendMessage(to, "")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                               try:
                                   ...
                                   kh.removeAllMessages(op.param2)
                                   sw.removeAllMessages(op.param2)
                                   cl.sendMessage(msg.to,"Chat deleted...")
                                   ki.sendMessage(msg.to,"Chat deleted...")
                                   kk.sendMessage(msg.to,"Chat deleted...")
                                   kc.sendMessage(msg.to,"Chat deleted...")
                                   kb.sendMessage(msg.to,"Chat deleted...")
                                   kd.sendMessage(msg.to,"Chat deleted...")
                                   ke.sendMessage(msg.to,"Chat deleted...")
                                   kf.sendMessage(msg.to,"Chat deleted...")
                                   kg.sendMessage(msg.to,"Chat deleted...")
                                   kh.sendMessage(msg.to,"Chat deleted...")
                               except:
                                   pass
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                timeCreated.append(time.strftime("%d-%m-%Y [ %H:%M:%S ]", time.localtime(int(G.createdTime) / 1000)))
                                ret_ += "「 Group Info 」"
                                ret_ += "\  ɴᴀᴍᴀ ɢʀᴜᴘ : {}".format(G.name)
                                ret_ += "\ ID Group : {}".format(G.id)
                                ret_ += "\ creator name : {}".format(gCreator)
                                ret_ += "\ time createGroup : {}".format(str(timeCreated))
                                ret_ += "\ Members : {}".format(str(len(G.members)))
                                ret_ += "\ Pendings : {}".format(gPending)
                                ret_ += "\ Group Qr : {}".format(gQr)
                                ret_ += "\ Group Ticket : {}".format(gTicket)
                                ret_ += "\ Picture Url : http://dl.profile.line-cdn.net/{}".format(G.pictureStatus)
                                ret_ += ""
                                cl.sendMessage(to, str(ret_))
                                cl.sendImageWithURL(msg.to, 'http://dl.profile.line-cdn.net/'+G.pictureStatus)
                            except:
...
#KICKALL
                        ...
                        elif cmd == "eric bots" or cmd == "bots":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "[☯️ CANNIBAL™️].")
                               elapsed_time = time.time() - start
                               ki.sendMessage(msg.to, "\𝕃𝔼𝔾𝔼ℕ𝔻 𝔹𝕆𝕋𝕊".format(str(elapsed_time)))
                               kk.sendMessage(msg.to, "\𝕃𝔼𝔾𝔼ℕ𝔻 𝔹𝕆𝕋𝕊".format(str(elapsed_time)))
                               kc.sendMessage(msg.to, "\𝕃𝔼𝔾𝔼ℕ𝔻 𝔹𝕆𝕋𝕊".format(str(elapsed_time)))
                               kb.sendMessage(msg.to, "\𝕃𝔼𝔾𝔼ℕ𝔻 𝔹𝕆𝕋𝕊".format(str(elapsed_time)))
                               kd.sendMessage(msg.to, "\𝕃𝔼𝔾𝔼ℕ𝔻 𝔹𝕆𝕋𝕊".format(str(elapsed_time)))
                               ke.sendMessage(msg.to, "\𝕃𝔼𝔾𝔼ℕ𝔻 𝔹𝕆𝕋𝕊".format(str(elapsed_time)))
                               kf.sendMessage(msg.to, "\𝕃𝔼𝔾𝔼ℕ𝔻 𝔹𝕆𝕋𝕊".format(str(elapsed_time)))
                               kj.sendMessage(msg.to, "\𝕃𝔼𝔾𝔼ℕ𝔻 𝔹𝕆𝕋𝕊".format(str(elapsed_time)))
                               sw.sendMessage(msg.to, "[𝕃𝔼𝔾𝔼ℕ𝔻 𝔹𝕆𝕋𝕊]")
                               #cl.sendMessage(msg.to, "╚☆Ⓐⓜⓐⓝ-☆╗\n╚ⒷⓄⓈ☆╮╗")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ...
                                    cl.sendMessage(msg.to,"Grup "+str(ginfo.name)+"hello darling")
                                except:
                                    pass
                            ...
                            if msg._from in admin:
                                ...
                                Ticket = cl.reissueGroupTicket(msg.to)
                                kj.acceptGroupInvitationByTicket(msg.to,Ticket)
                               # kj.sendMessage(msg.to, "Ghost in "+str(G.name))
                                sw.acceptGroupInvitationByTicket(msg.to,Ticket)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               # cl.sendMessage(msg.to, "she is a girl?")
                                ki.sendMessage(msg.to, "[ hello darling]2")
                                kk.sendMessage(msg.to, "[ hello darling]3")
                                kc.sendMessage(msg.to, "[ hello darling]4")
                                kb.sendMessage(msg.to, "[ hello darling]5")
                                kd.sendMessage(msg.to, "[ hello darling]6")
                                ke.sendMessage(msg.to, "[ hello darling]7")
                                kf.sendMessage(msg.to, "[ hello darling]8")
                                kj.sendMessage(msg.to, "[ hello darling]9")
                                sw.sendMessage(msg.to, "[ hello darling]10")
                                cl.sendMessage(msg.to, "")
...
#===========BOT UPDATE============#
                        elif msg.text in ["Cipok","Tagall","Desah","Emuach","شااكر","تاق","Siang","Sore","Malam","Nah","All"]:
                               if wait["selfbot"] == True:
                                if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"「 Daftar Admin 」\n\nSuper admin:\n"+ma+"\nAdmin:\n"+mb+"\nStaff:\n"+mc+"\nTotal" %(str(len(owner)+len(admin)+len(staff))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:                              
                               ...
                               kj.sendMessage(msg.to,format(str(elapsed_time/3)))
                               kb.sendMessage(msg.to,format(str(elapsed_time/3)))
...
#===========Hiburan============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           admin.append(target)
                                           ki.sendMessage(msg.to,"Done adding admin")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           staff.append(target)
                                           ki.sendMessage(msg.to,"Done adding staff")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           Bots.append(target)
                                           ki.sendMessage(msg.to,"Done adding bot")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                   if target not in Saints:
                                       try:
                                           admin.remove(target)
                                           ki.sendMessage(msg.to,"Done Dell admin")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                   if target not in Saints:
                                       try:
                                           staff.remove(target)
                                           ki.sendMessage(msg.to,"Done dell staff")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                   if target not in Saints:
                                       try:
                                           Bots.remove(target)
                                           ki.sendMessage(msg.to,"Done dell bot")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                    ...
                                    ki.sendMessage(msg.to,"Nothing in blacklist")
                                    kk.sendMessage(msg.to,"Nothing in blacklist")
                                    kc.sendMessage(msg.to,"Nothing in blacklist")
                                    kb.sendMessage(msg.to,"Nothing in blacklist")
                                    kd.sendMessage(msg.to,"Nothing in blacklist")
                                    ke.sendMessage(msg.to,"Nothing in blacklist")
                                    kf.sendMessage(msg.to,"Nothing in blacklist")
                                    kj.sendMessage(msg.to,"Nothing in blacklist")
                                    sw.sendMessage(msg.to,"Nothing in blacklist")
                              else:
                                    ma = ""
                        ...
                        elif cmd == "#cban" or text.lower() == '#clear':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              wait["blacklist"] = {}
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in protectantijs:
                                       msgs = "Anti JS  Actived"
                                  else:
                                       protectantijs.append(msg.to)
                                       ginfo = cl.getGroup(msg.to)
                                     #  msgs = "Anti JS Actived" +str(ginfo.name)
                                  cl.sendMessage(msg.to, "Actived\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectantijs:
                                         protectantijs.remove(msg.to)
                                         ginfo = cl.getGroup(msg.to)
                                      #   msgs = "Anti JS Shotdown : " +str(ginfo.name)
                                    else:
                                         msgs = "Anti JS Shotdown"
                                  ...
                                  cl.sendMessage(msg.to, "「Diaktifkan」\n" + msgs)
                                    ...
                                    if msg.to in ghost:
                                      ...
                                      #   msgs = "Ghost Dinonaktifkan\nDi Group : " +str(ginfo.name)
                                         ...
                                         msgs = "Ghost Shotdown"
                                    cl.sendMessage(msg.to, "Shotdown\n" + msgs)
#=========== [ Add Image ] ============#
                          ...
                          if msg._from in admin:
                            ...
                            if name in images:
                                ...
                                cl.sendText(msg.to, "Foto itu Nothing in dalam list") 
...
#=========== [ Add Video ] ============#                               
                          ...
                          if msg._from in admin:
                            ...
                            if name in videos:
                                ...
                                cl.sendText(msg.to, "Video itu Nothing in dalam list") 
...
#=========== [ Add Video ] ============#                               
                          ...
                          if msg._from in admin:
                            ...
                            if name in audios:
                                ...
                                cl.sendText(msg.to, "Mp3 itu Nothing in dalam list") 
...
#=========== [ Add Sticker ] ============#                                            
                          ...
                          if msg._from in admin:
                            ...
                            if name in stickers:
                                ...
                                cl.sendText(msg.to, "Sticker itu Nothing in dalam list") 
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/~reza.p.i.p\nhttp://line.me/ti/p/ryansakra_m1")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               cl.sendMessage(msg.to, "[ hello darling].")
                               elapsed_time = time.time() - start
                               cl.sendMessage(msg.to, "\𝕃𝔼𝔾𝔼ℕ𝔻 𝔹𝕆𝕋𝕊".format(str(elapsed_time)))
...
#===========Protection============#
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Welcome 」\n" + msgs)
                                    ...
                                    if msg.to in welcome:
                                         ...
                                         msgs = "Welcome Msg sudah Nothing aktif"
                                    cl.sendMessage(msg.to, "「 Status Welcome 」\n" + msgs)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect Url 」\n" + msgs)
                                    ...
                                    if msg.to in protectqr:
                                         ...
                                         msgs = "Protect url sudah Nothing aktif"
                                    cl.sendMessage(msg.to, "「 Status Protect Url 」\n" + msgs)
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect kick 」\n" + msgs)
                                    ...
                                    if msg.to in protectkick:
                                      ...
                                      #   msgs = "Status : [ OFF ]\nDi Group : " +str(ginfo.name)
                                         ...
                                         msgs = "Protect kick Shotdown"
                                    cl.sendMessage(msg.to, "「 Status Protect kick 」\n" + msgs)

                        elif '#pjoin ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('#pjoin ','')
                              if spl == 'on':
                                  if msg.to in protectjoin:
                                       msgs = "Protect join Actived"
                                  else:
                        ...
                        elif '#pcan ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('#pcan ','')
                              if spl == 'on':
                                  if msg.to in protectcancel:
                                       msgs = "Protect cancel Actived"
                                  else:
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect Cancel 」\n" + msgs)
                                    ...
                                    if msg.to in protectcancel:
                                      ...
                                      #   msgs = "Status : [ OFF ]\nDi Group : " +str(ginfo.name)
                                         ...
                                         msgs = "Protect cancel Shotdone"
                                    cl.sendMessage(msg.to, "「 Status Protect Cancel 」\n" + msgs)

                        elif '#pinv ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('#pinv ','')
                              if spl == 'on':
